...
require([
    ...
    function (Map, FeatureLayer, GeometryService, Editor, TemplatePicker, config, ready, parser, on, array, BorderContainer, ContentPane) {
// @formatter:on
        ...
        ready(function () {
             ...
             */
            flFirePoints = new FeatureLayer("http://sampleserver6.arcgisonline.com/arcgis/rest/services/Wildfire/FeatureServer/0", {outFields : ["*"]});

            flFireLines = new FeatureLayer("http://sampleserver6.arcgisonline.com/arcgis/rest/services/Wildfire/FeatureServer/1", {outFields : ["*"]});

            flFirePolygons = new FeatureLayer("http://sampleserver6.arcgisonline.com/arcgis/rest/services/Wildfire/FeatureServer/2", {outFields : ["*"]});
            ...
            function initEditor(results) {
                 ...
                 */
                var layersWildfire = array.map(results.layers, function(result){return result.layer
                });
