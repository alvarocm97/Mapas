require([
    ...
    "dojo/on",
    "dojo/_base/array"],
function (Map, Draw, Graphic, graphicsUtils, Geoprocessor, FeatureSet,LinearUnit, SimpleMarkerSymbol, SimpleLineSymbol, SimpleFillSymbol, Color,
...
// @formatter:on
    ...
    ready(function () {
        ...
        function calculateViewshed(evt) {
            ...
            luDistance.distance = 15000;
            luDistance.units = "esriMeters";
